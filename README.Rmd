...
```
- **[Fréchet Regression of Multivariate Distributions](vignettes/npt-regression.Rmd)**: Frechet regression of multivariate distributions and component-wise (marginals vs. dependence) interpretations.
```r
